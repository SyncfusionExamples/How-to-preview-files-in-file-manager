    ...
    public class FileManagerController : Controller
    {
        ...
        public IActionResult Save(SaveSettings saveSettings)
        {
            ...
            try
            {
                ...
                IFormFile formFile = new FormFile(fileStream, 0, fileStream.Length, "", saveSettings.FileName);
                string path = this.basePath + "\\wwwroot\\Files" + (saveSettings.FileName).Replace("/", "\\");
                ...
                using (var fileStream1 = new FileStream(path, FileMode.Create, FileAccess.Write))
                {
                    formFile.CopyTo(fileStream1);
                }
        ...
        [Route("SaveSpreadSheet")]
        [HttpPost]
        public IActionResult SaveSpreadSheet(SaveSettings saveSettings, [FromForm] string filepath)
        {
            ...
            try
            {
                ...
                string path = this.basePath + "\\wwwroot\\Files" + (filepath).Replace("/", "\\");
